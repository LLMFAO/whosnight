...
const SimpleCalendar = () => {
  ...
  const [assignments, setAssignments] = useState<{[key: number]: 'mom' | 'dad' | 'teen'}>({
  ...
  const assignDate = (day: number, assignment: 'mom' | 'dad' | 'teen') => {
...
const TaskList = () => {
  ...
  const getTaskColor = (assignedTo: string) => {
...
export default function App() {
  const [currentTab, setCurrentTab] = useState<'calendar' | 'tasks'>('calendar');
